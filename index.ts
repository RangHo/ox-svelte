...
/**
 * Directory name of the ox-svelte.el file.
 */
export const dirname = import.meta.url.substring(
  import.meta.url.indexOf('file://') + 7,
  import.meta.url.lastIndexOf('/')
);

/**
 * Base name of the ox-svelte.el file.
 */
export const basename = "ox-svelte.el";

/**
 * Full path to the ox-svelte.el file.
 */
export default dirname + "/" + basename;
